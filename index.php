...
<body id="html">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if($_POST["accion"]==2){
            ...
            $animal_especie = input($_POST["animal_especie"]);
            $animal_edad = input($_POST["animal_edad"]);
            $create = "insert into animals (name,especie,edad) values
            ('$animal_name','$animal_especie','$animal_edad')";
            $result = mysqli_query($conn, $create);
            if ($result) {
            ...
            <div class="col-md-10 col-md-offset-1">
                ...
                <div class="panel panel-default panel-table">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col col-xs-6">
                                <h3 class="panel-title">Animals Database</h3>
                            </div>
                            <!-- Crear animale -->
                            <div class="col col-xs-6 text-right">
                                <button type="button" class="btn btn-success" data-toggle="modal"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body text-left">
                                                <form form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post"
                                                    ...
                                                    <div class="form-group mb-2">
                                                        <label for="recipient-name"
                                                            class="col-form-label">species :</label>
                                                        <input type="text" class="form-control" id="animal_especie"
                                                            name="animal_especie" required>
                                                    </div>
                                                    <div class="form-group mb-2">
                                                        <label for="recipient-name"
                                                            class="col-form-label">age:</label>
                                                        <input type="text" class="form-control" id="animal_edad"
                                                            name="animal_edad" required>
                                                    </div>
                        ...
                        <table class="table table-bordered table-hover table-dark">
                            ...
                            <tbody>
                                ...
                                while ($animal_data = mysqli_fetch_array($result)) {
                                    ...
                                    echo "<td>" . $animal_data['name'] . "</td>";
                                    echo "<td>" . $animal_data['especie'] . "</td>";
                                    echo "<td>" . $animal_data['edad'] . "</td>";
